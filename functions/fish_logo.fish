# Defined in /home/matt/.local/share/omf/pkg/fish_logo/functions/fish_logo.fish @ line 1
function fish_logo --description 'Fish-shell colorful ASCII-art logo' --argument outer_color medium_color inner_color mouth eye
	
    [ $outer_color  ]; or set outer_color  'brblue'
